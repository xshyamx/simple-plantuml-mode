...
(defconst plantuml--component-types
  '("abstract" "action" "actor" "agent" "analog" "annotation"
    "archimate" "artifact" "binary" "boundary" "card" "class"
    "clock" "cloud" "collections" "component" "concise" "control"
    "database" "dataclass" "diamond" "entity" "enum" "exception"
    "file" "folder" "frame" "hexagon" "interface" "json" "label"
    "map" "metaclass" "network" "node" "nwdiag" "object" "package"
    "participant" "person" "process" "protocol" "queue" "record"
    "rectangle" "relationship" "robust" "stack" "state" "storage"
    "struct" "usecase")
  "Plantuml component types")

(defconst plantuml--diagram-types
  '("board" "bpm" "chen" "chronology" "creole" "cute" "def"
    "ditaa" "dot" "ebnf" "files" "flow" "gantt" "git" "hcl"
    "jcckit" "json" "latex" "math" "mindmap" "nwdiag" "project"
    "regex" "salt" "tree" "uml" "wbs" "wire" "yaml")
  "Plantuml diagram types")

(defconst plantuml--keywords
  '("across" "activate" "address" "again" "allow_mixing"
    "allowmixing" "also" "alt" "as" "attribute" "attributes"
    "autonumber" "backward" "bold" "bottom" "box" "break"
    "caption" "case" "center" "circle" "circled" "circles" "color"
    "create" "critical" "dashed" "deactivate" "description"
    "destroy" "detach" "dotted" "down" "else" "elseif" "empty"
    "end" "endcaption" "endfooter" "endfork" "endheader" "endif"
    "endlegend" "endmerge" "endswitch" "endtitle" "endwhile"
    "false" "field" "fields" "floating note" "footbox" "footer"
    "fork" "goto" "group" "header" "hide" "highlight" "hnote" "if"
    "is" "italic" "kill" "label" "left" "left to right direction"
    "legend" "link" "loop" "mainframe" "member" "members" "merge"
    "method" "methods" "namespace" "newpage" "normal" "not" "note"
    "null" "of" "on" "opt" "order" "over" "package" "page" "par"
    "partition" "plain" "private" "protected" "public" "ref"
    "repeat" "repeatwhile" "return" "right" "rnote" "rotate"
    "shape" "show" "skin" "skinparam" "split" "sprite" "start"
    "stereotype" "stereotypes" "stop" "style" "switch" "then"
    "title" "together" "top" "top to bottom direction" "true" "up"
    "while")
  "Plantuml keywords")
...
(defconst plantuml--skin-parameters
  '("ActivityBackgroundColor" "ActivityBorderColor"
    ...
    "ActivityDiamondFontStyle" "ActivityFontColor"
    "ActivityFontName" "ActivityFontSize" "ActivityFontStyle"
    "ActorBackgroundColor" "ActorBorderColor" "ActorFontColor"
    "ActorFontName" "ActorFontSize" "ActorFontStyle"
    "ActorStereotypeFontColor" "ActorStereotypeFontName"
    ...
    "ArchimateStereotypeFontStyle" "ArrowFontColor"
    "ArrowFontName" "ArrowFontSize" "ArrowFontStyle"
    ...
    "BackgroundColor" "BiddableBackgroundColor"
    "BiddableBorderColor" "BoundaryFontColor" "BoundaryFontName"
    "BoundaryFontSize" "BoundaryFontStyle"
    "BoundaryStereotypeFontColor" "BoundaryStereotypeFontName"
    "BoundaryStereotypeFontSize" "BoundaryStereotypeFontStyle"
    "BoxPadding" "CaptionFontColor" "CaptionFontName"
    "CaptionFontSize" "CaptionFontStyle" "CardBorderThickness"
    "CardFontColor" "CardFontName" "CardFontSize" "CardFontStyle"
    ...
    "ClassBackgroundColor" "ClassBorderColor"
    ...
    "HexagonFontSize" "HexagonFontStyle"
    ...
    "IconPublicBackgroundColor" "IconPublicColor"
    "InterfaceFontColor" "InterfaceFontName" "InterfaceFontSize"
    "InterfaceFontStyle" "InterfaceStereotypeFontColor"
    "InterfaceStereotypeFontName" "InterfaceStereotypeFontSize"
    "InterfaceStereotypeFontStyle" "LabelFontColor"
    "LabelFontName" "LabelFontSize" "LabelFontStyle"
    ...
    "LexicalBorderColor" "Linetype" "MachineBackgroundColor"
    "MachineBorderColor" "MachineBorderThickness"
    "MachineFontColor" "MachineFontName" "MachineFontSize"
    "MachineFontStyle" "MachineStereotypeFontColor"
    ...
    "ParticipantFontName" "ParticipantFontSize"
    ...
    "QueueFontColor" "QueueFontName" "QueueFontSize"
    "QueueFontStyle" "QueueStereotypeFontColor"
    "QueueStereotypeFontName" "QueueStereotypeFontSize"
    "QueueStereotypeFontStyle" "Ranksep"
    ...
    "RequirementFontName" "RequirementFontSize"
    "RequirementFontStyle" "RequirementStereotypeFontColor"
    ...
    "SequenceArrowThickness" "SequenceBoxBorderColor"
    "SequenceBoxFontColor" "SequenceBoxFontName"
    "SequenceBoxFontSize" "SequenceBoxFontStyle"
    ...
    "StateMessageAlignment" "StereotypePosition"
    "StorageFontColor" "StorageFontName" "StorageFontSize"
    "StorageFontStyle" "StorageStereotypeFontColor"
    "StorageStereotypeFontName" "StorageStereotypeFontSize"
    "StorageStereotypeFontStyle" "Style" "SvglinkTarget"
    "SwimlaneBorderThickness" "SwimlaneTitleFontColor"
    "SwimlaneTitleFontName" "SwimlaneTitleFontSize"
    "SwimlaneTitleFontStyle" "SwimlaneWidth"
    "SwimlaneWrapTitleWidth" "TabSize" "TimingFontColor"
    "TimingFontName" "TimingFontSize" "TimingFontStyle"
    "TitleBorderRoundCorner" "TitleBorderThickness"
    "TitleFontColor" "TitleFontName" "TitleFontSize"
    "TitleFontStyle" "UsecaseBorderThickness" "UsecaseFontColor"
    "UsecaseFontName" "UsecaseFontSize" "UsecaseFontStyle"
    "UsecaseStereotypeFontColor" "UsecaseStereotypeFontName"
    "UsecaseStereotypeFontSize" "UsecaseStereotypeFontStyle"
    "WrapWidth")
  "Plantuml skin parameters")

(defconst plantuml--preprocessor-keywords
  '("assert" "define" "definelong" "dump_memory" "else" "end"
    "enddefinelong" "endfor" "endfunction" "endif" "endprocedure"
    "endsub" "endwhile" "exit" "final" "foreach" "function" "if"
    "ifdef" "ifndef" "import" "include" "includedef" "includesub"
    "local" "log" "option" "pragma" "procedure" "return"
    "startsub" "theme" "undef" "unquoted" "while")
